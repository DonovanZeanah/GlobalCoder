...
#Include %A_ScriptDir%\autocompletion\eAutocomplete.ahk
list =
(Join`n
...
eAutocomplete.WordList.buildFromFile("mySource", A_ScriptDir . "\en", A_ScriptDir . "\autocompletion.dbg", true) ; -1
