#Include globalcoder_Filesystem.ahk
...
testInstance := new TestClassAgain()
Msgbox % testInstance.__Class
class TestClassAgain {
}

file1 := new File( A_ScriptFullPath ) ;a file object of our test.ahk
file2 := new File( "globalcoder_File.ahk" ) ;a file object of our "File.ahk" containing our file class
...
#Include globalcoder_FileSystem.ahk ;I named the file containing our classes FileSystem.ahk
*/
