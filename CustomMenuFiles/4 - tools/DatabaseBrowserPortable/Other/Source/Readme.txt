...
user in an INI file next to DatabaseBrowserPortable.exe called DatabaseBrowserPortable.ini.
...
copy AppNamePortable.ini from this directory to DatabaseBrowserPortable.ini next to
DatabaseBrowserPortable.exe. The options in the INI file are as follows:
