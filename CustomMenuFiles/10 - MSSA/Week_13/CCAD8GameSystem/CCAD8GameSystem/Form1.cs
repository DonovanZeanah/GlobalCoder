...
using WordGenerator;
using static CCAD8GameSystem.MainForm;
...
namespace CCAD8GameSystem
{
    public partial class Form1 : Form
    {
        ...
        public event UpdateGamePlayedStatCounters UpdateStatsEvent;
        ...
        private void ReportGameStats(bool isWin)
        {
            if (UpdateStatsEvent != null)
            {
                UpdateStatsEvent.Invoke(true);
                UpdateStatsEvent.Invoke(false);
                UpdateStatsEvent.Invoke(true);
                UpdateStatsEvent.Invoke(false);
                UpdateStatsEvent.Invoke(true);
                UpdateStatsEvent.Invoke(false);
