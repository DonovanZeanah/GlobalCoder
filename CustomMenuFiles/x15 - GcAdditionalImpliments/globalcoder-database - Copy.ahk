...
; Start & GUI
; ======================================================================================================================
CBBSQL := "SELECT * FROM Tools"
DBFileName := A_ScriptDir . "\workshop.DB"
...
SQL := "CREATE TABLE Tools (Id, Name, Fname, Price, Location, PRIMARY KEY(Id ASC, FName ASC));"
If !DB.Exec(SQL)
   MsgBox, 16, SQLite Error, % "Msg:`t" . DB.ErrorMsg . "`nCode:`t" . DB.ErrorCode
Sleep, 1000
...
SQLStr := ""
_SQL := "INSERT INTO Tools VALUES('Id#','Name#', 'Fname#', 'Price#', 'Location#');"
Loop, 100 {
...
^1::
InputBox, Id ,      Database,Enter:ID,, 300, 100, , , Font, Timeout, Default
InputBox, Name ,    Database,Enter:Name,, 300, 100, , , Font, Timeout, Default
InputBox, Fname ,   Database,Enter:Fname,, 300, 100, , , Font, Timeout, Default
InputBox, Price ,   Database,Enter:Price,, 300, 100, , , Font, Timeout, Default
InputBox, Location, Database,Enter:Location,, 300, 100, , , Font, Timeout, Default

SQL := "INSERT INTO Tools VALUES('" . Id . "','" . Name . "', '" . Fname . "', '" . Price . "', '" . Location . "');"
clipboard := sql
msgbox, % SQL
/*
Loop, 100 {
...
DB.Exec("COMMIT TRANSACTION;")
SQLStr := ""
SB_SetText("Exec: INSERT rows done in " . (A_TickCount - Start) . " ms")
Sleep, 1000
return
