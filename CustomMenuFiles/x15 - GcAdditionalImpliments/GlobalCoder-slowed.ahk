...
PrepareMenu(PATH)
{
	...
	/*static urls := { 0: ""
	   ...
	   Menu, %PATH%, Add,                                                         ; seperating
		...
		Menu, %PATH%"\Admin", Add, &4 Restart, ReloadProgram				; Add Reload option
		Menu, %PATH%"\Admin", Add, &3 Exit, ExitApp							; Add Exit option
...
static urls := { 0: ""
	...
	Sleep, 200
	Menu, %PATH%, Add, 													; seperating line
	Menu, %PATH%"\Admin", Add, &0 Go to Parent Folder, GoToRootFolder	; Open script folder
	Menu, %PATH%"\Admin", Add, &1 Add Custom Item, GoToCustomFolder		; Open custom folder
	Menu, %PATH%		  , Add,  % ScriptName " vers. " Version, github ;googler                        ; Name
	Menu, %PATH%"\Admin", Add, &8 Restart, ReloadProgram				; Add Reload option
