...
global v2_ahkpath := "C:\Program Files\AutoHotkey\v2\AutoHotkey64.exe"
global B_Params := []
Loop, %0%
	B_Params.Push(%A_Index%)

Menu, Tray, Icon, %v2_AhkPath%, 2
FileEncoding, UTF-8
...
class CodeQuickTester
{
	...
	EditorString := """" v2_AhkPath """ """ A_ScriptFullPath """ ""%1"""
	...
	class MenuButtons
	{
		...
		New()
		{
			Run, "%v2_AhkPath%" "%A_ScriptFullPath%"
		}
...
class ServiceHandler ; static class
{
	...
	Install()
	{
		...
		RegWrite, REG_SZ, HKCU, Software\Classes\%Protocol%\shell\open\command,, "%v2_Ahkpath%" "%A_ScriptFullPath%" "`%1"
	}
...
PreprocessScript(ByRef ScriptText, AhkScript, KeepComments=1, KeepIndent=1, KeepEmpties=0, FileList="", FirstScriptDir="", Options="", iOption=0)
{
	...
	{
		static AhkPath := A_IsCompiled ? A_ScriptDir "\..\AutoHotkey.exe" : v2_Ahkpath
		IfNotExist, %AhkPath%
...
class HelpFile
{
	static BaseURL := "ms-its:" v2_Ahkpath "\..\AutoHotkey.chm::/docs/"
	static Cache := {"Syntax": {}}
