 ...
 * $Id: Client.cs 10 2007-04-29 13:39:20Z mathieuk $
 * 
...
namespace xdc.XDebug
{
    ...
    public class Client
    {
        ...
        const string supportedLanguage = "ahk1"; // Lexikos: Changed from "php"
        ...
        private bool handleInitMessage(XDebug.Response initMessage)
        {
			...
			// Lexikos: Don't bail out; may as well try to support whatever language.
