...
eval(e,test:=false) { ; extend support for parenthesis
 ...
 return false
 Else If (test) {
 t1 := !RegExMatch(Trim(e),"i)(^[^\d!~\-\x28 ]|! |~ |[g-wyz]+|['\" . '"\https://github.com/TheArkive/eval_ahk2/blob/master/$@#%\{\}\[\]\\,;\``_])') ; only return true/false testing "e" as expression
 t2 := ( !InStr(e,"++") && !InStr(e,"--"))
 ...
 If RegExMatch(e,"i)(! |~ |[g-wyz]+|['\" . '"\https://github.com/TheArkive/eval_ahk2/blob/master/$@#%\{\}\[\]\\,;\``_])',&m) ; check for invalid characters, non-numbers, invalid punctuation, etc.
...
_eval(e) { ; support function for pure math expression without parenthesis
 ...
 If RegExMatch(e,"i)(^[^\d!~\-\x28 ]|! |~ |[g-wyz]+|['\" . '"\https://github.com/TheArkive/eval_ahk2/blob/master/$@#%\{\}\[\]\\,;\``_])',&m) ; check for invalid characters, non-numbers, invalid punctuation, etc.
