...
#include class_biga.ahk
A := new biga() ; requires https://github.com/biga-ahk/biga.ahk


string1 := "the day and the time an the industry"
string2 := "day time"




fn_removeshortwords(param_words, param_input) {
    return biga.join(biga.difference(biga.words(param_input), param_words), " ")
}

myfunc := func("fn_removeshortwords").bind(["a", "an", "the", "of", "in", "and"])



msgbox, % stringc.compare(string1, string2, myfunc)
