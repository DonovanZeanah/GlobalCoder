...
DefaultStartUp(){
  If debug
    ReadProjectFile("h:/globalcoder-main/ahk/1.ahkp")
...
Settings(Mode){
  ...
  If (Mode = "Read"){
    ;predefine Settings
    oSetting := {	 "AHK_Exec":     "C:\program files\AutoHotkey\AutoHotkey.exe"
                 , "AHK2EXE_Exec": "C:\program files\AutoHotkey\v2\autohotkey.exe"
                 , "AH2": "C:\program files\AutoHotkey\v2\autohotkey.exe"

                 , "Npp_Exec":     "C:\Program Files\Sublime Text\sublime_text.exe"
                 , "Npp_Title":    " - Sublime text"
